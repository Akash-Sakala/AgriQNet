...
const App: React.FC = () => {
  ...
  // Use getTranslation helper instead of direct access
  ...
  const renderContent = () => {
    ...
    switch (activeView) {
      case 'dashboard': return <Dashboard key={activeLang} lang={activeLang} user={user} />;
      case 'weather_station': return <SmartWeather key={activeLang} lang={activeLang} />;
      case 'crops': return <CropAdvisor key={activeLang} lang={activeLang} />;
      case 'fertilizer': return <FertilizerAdvisor key={activeLang} lang={activeLang} />;
      case 'pests': return <PestControl key={activeLang} lang={activeLang} />;
      case 'pest_alerts': return <PestAlerts key={activeLang} lang={activeLang} />;
      case 'chat': return <ChatModule key={activeLang} lang={activeLang} />;
      default: return <Dashboard key={activeLang} lang={activeLang} user={user} />;
    }
  };
